...
import com.favrora.prosms.BuildConfig
import com.favrora.prosms.R
import com.favrora.prosms.adapters.ConversationsAdapter
import com.favrora.prosms.dialogs.ExportMessagesDialog
import com.favrora.prosms.dialogs.ImportMessagesDialog
import com.favrora.prosms.extensions.*
import com.favrora.prosms.helpers.EXPORT_MIME_TYPE
import com.favrora.prosms.helpers.MessagesExporter
import com.favrora.prosms.helpers.THREAD_ID
import com.favrora.prosms.helpers.THREAD_TITLE
import com.favrora.prosms.models.Conversation
import com.favrora.prosms.models.Events
...
class MainActivity : com.favrora.prosms.activities.SimpleActivity() {
    ...
    private fun setupConversations(conversations: ArrayList<Conversation>) {
        ...
        if (currAdapter == null) {
            ...
            ConversationsAdapter(this, sortedConversations, conversations_list) {
                Intent(this, com.favrora.prosms.activities.ThreadActivity::class.java).apply {
    ...
    private fun launchNewConversation() {
        hideKeyboard()
        Intent(this, com.favrora.prosms.activities.NewConversationActivity::class.java).apply {
            startActivity(this)
        }
    }
    ...
    private fun getCreateNewContactShortcut(appIconColor: Int): ShortcutInfo {
        ...
        val intent = Intent(this, com.favrora.prosms.activities.NewConversationActivity::class.java)
    ...
    private fun launchSearch() {
        hideKeyboard()
        startActivity(Intent(applicationContext, com.favrora.prosms.activities.SearchActivity::class.java))
    }

    private fun launchSettings() {
        hideKeyboard()
        startActivity(Intent(applicationContext, com.favrora.prosms.activities.SettingsActivity::class.java))
    }
