...
import com.favrora.smsgram.dialogs.ExportMessagesDialog
import com.favrora.smsgram.dialogs.ImportMessagesDialog
import com.favrora.smsgram.extensions.*
import com.favrora.smsgram.helpers.EXPORT_MIME_TYPE
import com.favrora.smsgram.helpers.MessagesExporter
import com.favrora.smsgram.helpers.THREAD_ID
import com.favrora.smsgram.helpers.THREAD_TITLE
import com.favrora.smsgram.models.Conversation
import com.favrora.smsgram.models.Events
...
class MainActivity : com.favrora.smsgram.activities.SimpleActivity() {
    ...
    private fun setupConversations(conversations: ArrayList<Conversation>) {
        ...
        if (currAdapter == null) {
            ...
            ConversationsAdapter(this, sortedConversations, conversations_list) {
                Intent(this, com.favrora.smsgram.activities.ThreadActivity::class.java).apply {
    ...
    private fun launchNewConversation() {
        hideKeyboard()
        Intent(this, com.favrora.smsgram.activities.NewConversationActivity::class.java).apply {
            startActivity(this)
        }
    }
    ...
    private fun getCreateNewContactShortcut(appIconColor: Int): ShortcutInfo {
        ...
        val intent = Intent(this, com.favrora.smsgram.activities.NewConversationActivity::class.java)
    ...
    private fun launchSearch() {
        hideKeyboard()
        startActivity(Intent(applicationContext, com.favrora.smsgram.activities.SearchActivity::class.java))
    }

    private fun launchSettings() {
        hideKeyboard()
        startActivity(Intent(applicationContext, com.favrora.smsgram.activities.SettingsActivity::class.java))
    }
